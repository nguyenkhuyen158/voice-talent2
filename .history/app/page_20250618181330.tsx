...
export default function Home() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [projectsResponse, partnersResponse, contactResponse] = await Promise.all([
          fetch('/api/projects'),
          fetch('/api/partners'),
          fetch('/api/contact')
        ]);
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-blue-600/20 flex items-center justify-center group-hover:bg-blue-600/30 transition-colors">
                      <Image src="/social/facebook.svg" alt="Facebook" width={24} height={24} className="opacity-70 group-hover:opacity-100" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Facebook</div>
                      <div className="text-sm text-white/60">Voice Talent</div>
                    </div>
                  </a>
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center group-hover:bg-blue-500/30 transition-colors">
                      <Image src="/social/Icon_of_Zalo.webp" alt="Zalo" width={24} height={24} className="opacity-70 group-hover:opacity-100" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Zalo</div>
                      <div className="text-sm text-white/60">0123.456.789</div>
                    </div>
                  </a>
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-green-500/20 flex items-center justify-center group-hover:bg-green-500/30 transition-colors">
                      <Image src="/social/phone.svg" alt="Phone" width={24} height={24} className="opacity-70 group-hover:opacity-100" />
                    </div>
                    <div>
                  ...
                  <a
                    href="mailto:contact@voicetalent.vn"
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center group-hover:bg-purple-500/30 transition-colors">
                      <Image src="/social/email.svg" alt="Email" width={24} height={24} className="opacity-70 group-hover:opacity-100" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Email</div>
                      <div className="text-sm text-white/60 truncate">contact@voicetalent.vn</div>
                    </div>
                  </a>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-orange-500/20 flex-shrink-0 flex items-center justify-center mt-1">
                      <Image src="/social/location.svg" alt="Location" width={24} height={24} className="opacity-70" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Trụ sở chính</div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-teal-500/20 flex-shrink-0 flex items-center justify-center mt-1">
                      <Image src="/social/clock.svg" alt="Working Hours" width={24} height={24} className="opacity-70" />
                    </div>
                    <div>
                      <div className="font-medium text-white">Giờ làm việc</div>
                      <div className="text-white/60 mt-1">
