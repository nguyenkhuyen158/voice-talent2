            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600/10 to-purple-600/10 flex items-center justify-center mb-4 group-hover:from-blue-600/20 group-hover:to-purple-600/20 transition-all duration-300">
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 blur-xl group-hover:blur-2xl transition-all duration-300 opacity-75" />
                    <Image
                      src={service.icon}
                      alt={service.title}
                      width={32}
