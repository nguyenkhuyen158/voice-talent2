...
import { 
  MicrophoneIcon, 
  PlayCircleIcon,
  DocumentTextI                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center mb-4 group-hover:from-blue-400 group-hover:to-blue-500 transition-all duration-300">
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-400 to-blue-600 blur-xl group-hover:blur-2xl transition-all duration-300 opacity-50" />
                    <Image
                      src={service.icon}
                      alt={service.title}
                      width={32}
                      height={32}
                      className="relative z-10 brightness-[2] opacity-90 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110 drop-shadow-[0_0_12px_rgba(59,130,246,0.8)]"
                    />erGroupIcon,
  AcademicCapIcon,
  EnvelopeIcon,
  SpeakerWaveIcon,
            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-600/10 to-blue-400/10 flex items-center justify-center mb-4 group-hover:from-blue-600/20 group-hover:to-blue-400/20 transition-all duration-300">
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-400/10 blur-xl group-hover:blur-2xl transition-all duration-300 opacity-75" />
                    <Image
                      src={service.icon}
                      alt={service.title}
                      width={32}
                      height={32}
                      className="relative z-10 opacity-80 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110 drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]"
                    />
                  </div>
                </div>
