            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-green-500/20 to-green-600/20 flex items-center justify-center mb-4 group-hover:from-green-400/30 group-hover:to-green-500/30 transition-all duration-300 relative">
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-green-400/20 to-green-600/20 blur-xl group-hover:blur-2xl transition-all duration-300 opacity-50" />
                    <Image
                      src={service.icon}
                      alt={service.title}
                      width={32}
                      height={32}
                      className="relative z-10 brightness-150 opacity-90 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110 drop-shadow-[0_0_12px_rgba(59,130,246,0.8)]"
                    />
                  </div>
                </div>
