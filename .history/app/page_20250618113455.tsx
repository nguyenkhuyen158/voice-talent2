              ...
              >
                <div className="aspect-video bg-gradient-to-br from-blue-500/20 to-purple-500/20 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <PlayCircleIcon className="w-16 h-16 text-white/50 group-hover:text-white/90 transition-colors" />
                  </div>
                </div>
                <div className="p-6">
          ...
          >
            <div className="partner-grid">
              {[
                ...
                "Mobile Legends", "Garena", "Netflix Vietnam", "TikTok"
              ].map((partner, idx) => (
                <motion.div
                  key={idx}
                ...
                >
                  <div className="w-32 h-32 mx-auto glass-card flex items-center justify-center p-6 group hover:bg-white/20">
                    <span className="text-xl font-bold text-white/70 group-hover:text-white/90">{partner}</span>
                  </div>
                </motion.div>
              ))}
            </div>
