            ...
            {services.map((service, idx) => (
              ...
              >
                <div className="relative">
                  <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/20 to-blue-600/20 flex items-center justify-center mb-4 group-hover:from-blue-400/30 group-hover:to-blue-500/30 transition-all duration-300 relative">
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-400/20 to-blue-600/20 blur-xl group-hover:blur-2xl transition-all duration-300 opacity-50" />
                    <Image
                      src={service.icon}
                      alt={service.title}
                      width={32}
