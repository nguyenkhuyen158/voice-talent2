        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="hidden md:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Size</th>
              <th scope="col" className="hidden lg:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Last Modified</th>
              <th scope="col" className="hidden md:table-cell px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Preview</th>
                      ...
                      <div className="relative group">
                        ...
                        <div className="hidden group-hover:block absolute z-10 bottom-full left-1/2 transform -translate-x-1/2 mb-2">
                          <img
                            src={`/${file.path}`}
                            alt={file.name}
                            className="max-w-[200px] max-h-[200px] object-contain bg-white rounded-lg shadow-lg border border-gray-200"
                          />
                        </div>
                      </div>
                    ) : (
