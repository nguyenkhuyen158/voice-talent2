...
export function middleware(request: NextRequest) {
    ...
    try {
        ...
        // Tạo headers mới với thông tin visitor
        const requestHeaders = new Headers(request.headers);
        requestHeaders.set('x-visitor-ip', clientIP);
        requestHeaders.set('x-visitor-session', sessionId);

        // Tạo request mới với headers đã cập nhật
        ...
        // Trả về response với request đã cập nhật
