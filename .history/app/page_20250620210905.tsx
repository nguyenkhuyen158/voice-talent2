...
simport toast, { Toaster } from 'react-hot-toast';
import { 
  PlayCircleIcon,
  UserGroupIcon,
  EnvelopeIcon,
...
export default function Home() {
  // Thêm usePageView để ghi nhận lượt truy cập
  usePageView();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [projectsResponse, partnersResponse, servicesResponse, contactResponse, heroResponse] = await Promise.all([
          fetch('/api/projects'),
          fetch('/api/partners'),
          fetch('/api/services'),
          fetch('/api/contact'),
              ...
              <form 
                ...
                onSubmit={async (e) => {
                  ...
                  if (!contactData?.social.email.name) {
                    toast.error('Không tìm thấy email nhận liên hệ!');
                  ...
                  try {
                    ...
                    if (!res.ok || data.error) {
                      ...
                      const error = data.error || 'Gửi tin nhắn thất bại!';
                    ...
                    // Nếu có lỗi exception hiển thị thông báo thất bại
                    ...
                    if (e.target instanceof HTMLFormElement) {
                      const inputs = e.target.querySelectorAll<HTMLInputElement | HTMLTextAreaElement>('input, textarea');
      ...
      <footer className="py-12 glass-card mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="mt-4 space-x-4">
            ...
            <a href="#" className="text-white/60 hover:text-white transition-colors">Zalo</a>
            <a href="#" className="text-white/60 hover:text-white transition-colors">Điện thoại</a>
