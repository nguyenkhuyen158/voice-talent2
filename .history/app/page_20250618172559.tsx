              ...
              {partners.map((partner) => (
                ...
                >
                  {partner.logo ? (
                    ...
                    <span className="text-xl font-bold text-white/70 text-center group-hover:text-white transition-colors">
                      {partner.name}
                    </span>
                  )}
                  <span className="text-sm text-white/50 text-center group-hover:text-white/70 transition-colors">
                    {partner.category}
                  </span>
                </div>
              ))}
