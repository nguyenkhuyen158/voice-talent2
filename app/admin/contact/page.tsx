      ...
      {contactData && (
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="grid gap-4">              {Object.entries(contactData.social).map(([platform, data]) => {
                const socialKey = platform as keyof ContactData['social'];
                return (
                  <div key={platform} className="glass-card p-4 space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={editedData?.social[socialKey].name || ''}
                          onChange={(e) => handleSocialChange(socialKey, 'name', e.target.value)}
                          disabled={!isEditing}
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={editedData?.social[socialKey].url || ''}
                          onChange={(e) => handleSocialChange(socialKey, 'url', e.target.value)}
                          disabled={!isEditing}
                          className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white disabled:opacity-50"
                        />
                      </div>
          ...
          <section>
            ...
            <div className="grid gap-4">              {Object.entries(contactData.office).map(([type, data]) => {
                const officeKey = type as keyof ContactData['office'];
                return (
                  <div key={type} className="glass-card p-4 space-y-4">
                    ...
                    <div className="grid gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={editedData?.office[officeKey].title || ''}
                          onChange={(e) => handleOfficeChange(officeKey, 'title', e.target.value)}
                          disabled={!isEditing}
                          className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white disabled:opacity-50"
                        />
                      </div>
                      <div>
                        ...
                        <textarea
                          value={editedData?.office[officeKey].content || ''}
                          onChange={(e) => handleOfficeChange(officeKey, 'content', e.target.value)}
                          disabled={!isEditing}
                          rows={3}
                          className="w-full px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white disabled:opacity-50"
                        />
